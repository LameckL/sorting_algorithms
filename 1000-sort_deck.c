...
/**
 * _strcmp - func comparing two strings
 * @s1: first string
 * @s2: second string
 *
...
/**
 * insertion_sort_deck_kind - func soring cards deck from spades to diamonds
...
/**
 * insertion_sort_deck_value - func sorting a deck of cards sorted
...
/**
 * sort_deck - func sorting cards deck from ace to king then
